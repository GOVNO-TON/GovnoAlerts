# GovnoAlerts — Кроссплатфомренное приложение для криптовалютных донатов стримерам
...
- **Поддержка иновационной криптовалюты**: Работа с криптовалютой [$GOVNO](https://tonviewer.com/EQBlWgKnh_qbFYTXfKgGAQPxkxFsArDOSr9nlARSzydpNPwA) на блокчейне TON.
...
## Установка
0. Для MacOS может потребоваться PathAudio
    ```
...
- Поставте галочку в пункте "Управление аудио через OBS";
